...
/* SIM2FIELD authored-typography guard.
   ...
   Unicode that legitimately comes from the rendering engine or is genuine notation:
     ...
     Allowed
       ...
       - Non-forbidden science/diagram symbols: Greek, math operators (<= >= x div
         approx norm middot etc.), degree sign, subscripts/superscripts, diacritics
     ...
     Forbidden (authored punctuation + horizontal flow arrows)
       ...
       U+2500/2502/251C/2524/252C/2534/253C/250C/2510/2514/2518 BOX-DRAWING (-> - | +)
       U+25BC/25BA/25B6/25C4 POINTERS (-> v > > <)   U+2193/2191/21A9 VERT/HOOK ARROWS
       U+25CF/25CB WHITE/BLACK CIRCLE (-> X o)  U+25C6/25C7 DIAMONDS (dropped)
       U+2605 STAR (-> *)  U+2705/2713 CHECK (-> [x])  U+274C CROSS (-> [ ])  U+25D1 HALF (-> [~])
       U+27E8/27E9 MATH ANGLE BRACKETS as prose placeholders (-> \< \>)
...
const FORBIDDEN = {
  ...
  // Bucket-1 (converted to ASCII; math notation stays allowed and KaTeX output is masked)
  0x00a7: "SECTION SIGN",
  0x2500: "BOX H", 0x2502: "BOX V", 0x251c: "BOX VR", 0x2524: "BOX VL", 0x252c: "BOX DH",
  0x2534: "BOX UH", 0x253c: "BOX VH", 0x250c: "BOX DR", 0x2510: "BOX DL", 0x2514: "BOX UR", 0x2518: "BOX UL",
  0x25bc: "BLACK DOWN TRIANGLE", 0x25ba: "BLACK RIGHT POINTER", 0x25b6: "BLACK RIGHT TRIANGLE", 0x25c4: "BLACK LEFT POINTER",
  0x2193: "DOWNWARDS ARROW", 0x2191: "UPWARDS ARROW", 0x21a9: "LEFTWARDS ARROW WITH HOOK",
  0x25cf: "BLACK CIRCLE", 0x25cb: "WHITE CIRCLE", 0x25c6: "BLACK DIAMOND", 0x25c7: "WHITE DIAMOND",
  0x2605: "BLACK STAR", 0x2705: "WHITE HEAVY CHECK MARK", 0x2713: "CHECK MARK", 0x274c: "CROSS MARK", 0x25d1: "CIRCLE RIGHT HALF BLACK",
  0x27e8: "MATH LEFT ANGLE BRACKET", 0x27e9: "MATH RIGHT ANGLE BRACKET"
};
